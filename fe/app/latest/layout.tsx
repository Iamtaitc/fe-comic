...
export const metadata: Metadata = {
  title: "Truyện Mới Cập Nhật | SubTruyện",
  description:
    "Khám phá những bộ truyện được cập nhật gần đây nhất với các chương mới và nội dung hấp dẫn nhất.",
  keywords: [
    "truyện mới cập nhật",
    "latest manga",
    "manga mới",
  ...
  openGraph: {
    ...
    description:
      "Theo dõi những bộ truyện với chương mới được cập nhật liên tục",
    type: "website",
    images: [
      {
...
// 🔄 Enhanced skeleton với Page Transition awareness
...
export default function LatestLayout({
  ...
  return (
    <>
      ...
      {/* 🔄 Page Transition aware Suspense */}
